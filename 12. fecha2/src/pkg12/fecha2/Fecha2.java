...
public class Fecha2 {
    ...
    public static void main(String[] args) throws ParseException {
        ...
        System.out.println(persona.getNombre() + " tiene " + sv.calcularEdad(persona) + " años.");
        System.out.println("Digite otra edad");
        int edad2 = leer.nextInt();
        sv.menorQue(persona, edad2);
    }
